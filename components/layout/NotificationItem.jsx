                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-2 mt-3">
                                    <Badge
                                        ...
                                        className="flex-1 text-xs text-center px-2 py-0.5 transition-all duration-200 hover:scale-105"
                                    >
                                        {config.label}
                                    </Badge>
                                    ...
                                    {config.category ===
                                        ...
                                        <Badge
                                            variant="outline"
                                            className="flex-1text-xs px-2 py-0.5 bg-gray-50 dark:bg-gray-800"
                                        >
                                            {notification.type}
                                        </Badge>
                                    )}
                                    <span className="flex-1 text-xs text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded-full">
                                        {format(

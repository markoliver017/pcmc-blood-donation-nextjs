    ...
    return (
        <Card >
            <CardHeader>
                ...
                <CardDescription>
                    Currently, registration is open only to members of our partner agencies.
                </CardDescription>
                <CardContent className="mt-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {agencies.map((agency, i) => (
                            <Link href={`/organizers/${agency.id}/register`} key={i} >
                                ...
                                <Card className="hover:ring-2 hover:ring-blue-400 group transition shadow-lg/40">
                                    ...
                                    <div className="flex items-center gap-2 p-5">
                                        ...
                                        <div className='flex-1 flex flex-col gap-2'>
                                            ...
                                            <span className='text-xs'>{agency.agency_address}</span>
                                        </div>
                                    </div>
                                </Card>
                            </Link>

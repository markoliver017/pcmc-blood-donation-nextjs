...
const UserModel = (sequelize, DataTypes) => {
        ...
        "user",
        {
            ...
            first_name: {
                ...
                validate: {
                    ...
                    is: {
                        args: /^[A-Za-z\sñÑ]+$/, // Allows only letters and spaces
            ...
            middle_name: {
                ...
                validate: {
                    isValid(value) {
                        if (value && !/^[A-Za-z\sñÑ]+$/.test(value)) {
                            throw new Error(
    ...
    User.associate = (models) => {
        ...
        User.hasOne(models.AgencyCoordinator, {
            foreignKey: "user_id",
            as: "coordinator",
            onDelete: "CASCADE",
        });

        User.hasOne(models.BloodDonationHistory, {
            foreignKey: "user_id",
            as: "blood_history",
        });

...
export const userSchema = z
    .object({
        ...
        first_name: z
            ...
            .regex(/^[A-Za-z\sñÑ]+$/, "Invalid characters."),
        middle_name: z
            .string({
            ...
            .regex(/^[A-Za-z\sñÑ]*$/, "Invalid characters.") // Allows empty strings
            .optional(),
...
export const userBasicWithCredentials2 = z.object({
    role_ids: z
        .array(
            z.number({
                required_error: "Role type field is required.",
    ...
    middle_name: z
        ...
        .nonempty("Middle Name field is required.")
...
export const getUserBasicInformationSchema = (isDonor = false) =>
    z.object({
        id: z
            .string({
                required_error: "User ID is required",
...
export const donorBasicInformationSchema = z.object({
    first_name: z
        .string({
            required_error: "First Name field is required",
            invalid_type_error: "Please enter a valid first name",

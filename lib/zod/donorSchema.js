...
export const donorSchema = z.object({
    ...
    donation_history_donation_date: z.string().optional().nullable(),
    blood_service_facility: z.string().optional().nullable(),
    comments: z
        .string({
...
export const donorSchemaForOrganizer = donorSchema.pick({
    date_of_birth: true,
    civil_status: true,
    contact_number: true,
    nationality: true,
    ...
    blood_type_id: true,
    donation_history_donation_date: true,
    blood_service_facility: true,
    comments: true,
    id_url: true,
    file: true,
});

export const existingUserAsDonorSchema = donorSchemaForOrganizer.superRefine(
    (data, ctx) => {
        if (data.is_regular_donor) {
            if (!data.blood_type_id) {
                ctx.addIssue({
...
export const updateDonorAgencySchema = donorSchema
    .pick({
        user_id: true,
        agency_id: true,
    })

...
export const donorWithVerifiedSchema = donorSchema
    .merge(
        z.object({
            is_data_verified: z.literal(true, {
                errorMap: () => ({
                    message: "You must verify the donor's information before you proceed.",
                }),
            })
        })
    );

export const userWithDonorSchema = donorWithVerifiedSchema
    .merge(donorBasicInformationSchema);

...
export const agencySchema = z.object({
    ...
    head_id: z.optional(z.number().int()),
    ...
    contact_number: z
        ...
        .min(9, "Contact number at least 9 characters long.")
        .max(15, "Contact number must be at most 15 digits long.")
        .regex(philippinePhoneRegex, "Please enter a valid Philippine contact number"),
    address: z
        .string({

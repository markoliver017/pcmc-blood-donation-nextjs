        ...
        <div className="space-y-4">
            ...
            {appointments.slice(0, 2).map((appt) => {
                ...
                return (
                    <div
                        key={appt.id}
                        className="md:items-center space-y-2 justify-between p-4 rounded-lg shadow border border-blue-100"
                    >
                        <div className="flex-1 min-w-0 ">
                            <div className="flex justify-between ">
                                <div className="flex-1 flex items-center gap-2 text-blue-700 dark:text-blue-400 font-semibold text-lg">

...
import RejectDialog from "../../(index)/RejectDialog";
import VerifyAgency from "../../(index)/VerifyAgency";
...
export default function AgencyUpdateForm({ agency_id }) {
    ...
    return (
        <Card className="px md:px-5 bg-gray-100">
            <CardHeader className="text-2xl font-bold">
                <div className="flex justify-between mb-5">
                    <div className="flex flex-1 flex-wrap gap-3 md:gap-10">
                        <Link
                            href="/agencies"
                            className="btn btn-default hover:text-blue-300"
                        >
                            <ArrowLeft />
                        </Link>
